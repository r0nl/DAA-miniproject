...
"""
OUTPUT :-
Enter the number of rows in first matrix: 10
...
"""
The following data has been calculated by varying the number of rows of first matrix while keeping the other parameters constant with the values:-
A_col = 5, B_row = 5, B_col = 10
-----------------------------------------------------------------------------------------
|   Rows in solution matrix |   Multi Threaded Approach     |   Single Threaded Approach|
-----------------------------------------------------------------------------------------
|   1                       |   0.0006 seconds              |   0.00084 seconds         |
-----------------------------------------------------------------------------------------
|   10                      |   0.00365 seconds             |   0.00505 seconds         |
-----------------------------------------------------------------------------------------
|   100                     |   0.03674 seconds             |   0.04759 seconds         |
-----------------------------------------------------------------------------------------
|   1000                    |   0.18645 seconds             |   0.27385 seconds         |
-----------------------------------------------------------------------------------------
|   10000                   |   2.20707 seconds             |   2.93676 seconds         |
-----------------------------------------------------------------------------------------
|   100000                  |   24.5927 seconds             |   31.8781 seconds         |
-----------------------------------------------------------------------------------------
"""